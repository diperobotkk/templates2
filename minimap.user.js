...
// @homepage     discord.io/brzone
// @updateURL    https://raw.githubusercontent.com/zAsuma/brtemplates/master/minimap_meatie.js
// @grant        none
// ==/UserScript==

// Default location of template images and templates.json. Is user input and stored in a cookie.
var baseTemplateUrl = 'https://raw.githubusercontent.com/zAsuma/brtemplates/master/'; //only as default
var vers = "👑 Império Brasil 👑";
...
window.addEventListener('load', function() {
  ...
  div.innerHTML = '<style>.grecaptcha-badge,#message{display: none;}</style>\n' +
    '<div id="minimapbg" style="background-color:rgba(0,0,0,0.75); border-radius:0px; position:absolute; right:0px; bottom:0px; z-index:1;">' +
